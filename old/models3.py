...
class RoomAdmin(AdminModelView):
    ...
    form_extra_fields = {
        'id_floor': QuerySelectField('Этаж', query_factory=lambda: Floor.query.all(), get_label='name_floor', allow_blank=True)
    }
...
admin.add_view(BuildingAdmin(Building, db.session, name='Корпусы'))
